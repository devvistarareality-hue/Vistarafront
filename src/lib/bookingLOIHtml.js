...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .hdr .clogo, .hdr .plogo { position: absolute; top: 9px; width: 92px; height: 52px; object-fit: contain; background: #fff; border-radius: 5px; padding: 4px; box-sizing: border-box; }
  .hdr .clogo { left: 12px; }
  .hdr .plogo { right: 12px; }
