...
// ── Platform admins ──────────────────────────────────────────────────────────
// Who counts as a platform super-admin — across every company, not just their
// own. Mirrors web/src/lib/moduleAccess.js and backend/accounts/views.py::
// is_platform_admin; keep all three in step.
// This lived in utils/club1000Access.js while Club 1000 was its only caller. It
// is not a Club 1000 rule, so it sits here now and that file imports it.
