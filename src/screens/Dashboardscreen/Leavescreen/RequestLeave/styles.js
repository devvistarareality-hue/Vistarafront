...
export default StyleSheet.create({
  ...
  descCard: {
    backgroundColor: COLORS.cardBg, borderRadius: 22, paddingHorizontal: 16,
  ...
  dropdownCard: {
    ...
    backgroundColor: COLORS.cardBg, borderRadius: 22, paddingHorizontal: 16, paddingVertical: 14,
    marginBottom: 14, ...CARD_SHADOW,
   borderWidth: 1, borderColor: COLORS.cardBorder },
