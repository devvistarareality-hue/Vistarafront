...
const s = StyleSheet.create({
  ...
  btn:           { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.btnTint, paddingHorizontal: 28, paddingVertical: 14, borderRadius: 18 ,  borderWidth: 1, borderColor: COLORS.btnBorder },
