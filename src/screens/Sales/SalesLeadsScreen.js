  ...
  return (
    <>
      <TouchableOpacity onPress={() => setOpen(true)}
        style={{ borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 9, backgroundColor: COLORS.white, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
        <View style={{ flex: 1 }}>
          {selected ? (
            <>
            ...
            {tab === 'detail' && <>
              ...
              <View style={row2}>
                ...
                <View style={half}>
                  ...
                  <TextInput value={form.alt_phone} onChangeText={v => set('alt_phone', v)} keyboardType="phone-pad" style={inpS} placeholder="Add alternate" placeholderTextColor="#55585E" />
                </View>
              </View>
              ...
              <View style={row2}>
                <View style={half}>
                  ...
                  {cityOther && (
                    <TextInput value={form.city} onChangeText={v => set('city', v)} style={{ ...inpS, marginTop: 6 }} placeholder="Enter city" placeholderTextColor="#55585E" />
                  )}
                </View>
                <View style={half}>
              ...
              <TextInput value={form.address} onChangeText={v => set('address', v)}
                ...
                placeholder="Address" placeholderTextColor="#55585E" />
              ...
              <TextInput value={form.telecaller_remarks} onChangeText={v => set('telecaller_remarks', v)}
                multiline placeholder="Call notes…" placeholderTextColor="#55585E"
              ...
              <TextInput value={form.stm_remarks} onChangeText={v => set('stm_remarks', v)}
                multiline placeholder="Notes…" placeholderTextColor="#55585E"
                style={[inpS, { minHeight: 60, textAlignVertical: 'top' }]} />

              {/* Inline site-visit scheduling when STM picks "sv_scheduled" */}
              {form.stm_status === 'sv_scheduled' && (
                <View style={{ backgroundColor: '#F4F5F7', borderWidth: 1, borderColor: '#C9F8CA', borderRadius: 16, padding: 12, marginTop: 12 }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                    <Ionicons name="location-outline" size={14} color="#23874A" />
                    <Text style={{ fontSize: 11, fontWeight: '800', color: '#23874A', letterSpacing: 0.5 }}>SCHEDULE SITE VISIT</Text>
                  </View>
                  <Text style={[lblS, { color: '#23874A' }]}>Date & Time *</Text>
                  <View style={{ flexDirection: 'row', gap: 8 }}>
                    <TouchableOpacity onPress={() => setShowSvDate(true)} style={{ flex: 1, borderWidth: 1.5, borderColor: COLORS.link, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.white }}>
                    ...
                    <TouchableOpacity onPress={() => setShowSvTime(true)} style={{ flex: 1, borderWidth: 1.5, borderColor: COLORS.link, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.white }}>
                  ...
                  <Text style={[lblS, { color: '#23874A', marginTop: 8 }]}>Visit Remarks</Text>
                  ...
                  {!svAt && <Text style={{ fontSize: 11, color: '#23874A', marginTop: 6 }}>Set a date & time to create a site visit entry automatically on save.</Text>}
              ...
              {form.stm_status === 'sv_done' && (
                <View style={{ backgroundColor: '#F4F5F7', borderWidth: 1, borderColor: '#C9F8CA', borderRadius: 16, padding: 12, marginTop: 12 }}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                    <Ionicons name="location-outline" size={14} color="#23874A" />
                    <Text style={{ fontSize: 11, fontWeight: '800', color: '#23874A', letterSpacing: 0.5 }}>VISIT OUTCOME</Text>
                  </View>
                  <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
                    {[['hot', 'Hot', '#D9434B'], ['warm', 'Warm', '#D98A1F'], ['cold', 'Cold', '#2F6DB5'], ['not_interested', 'Not Interested', COLORS.textSecondary]].map(([val, label, color]) => {
                      const active = svOutcome === val;
                      return (
                        <TouchableOpacity key={val} onPress={() => setSvOutcome(val)}
                          style={{ flexBasis: '47%', flexGrow: 1, borderWidth: 1.5, borderColor: color, borderRadius: 14, paddingVertical: 10, alignItems: 'center', backgroundColor: active ? color : COLORS.white }}>
                          <Text style={{ fontSize: 13, fontWeight: '700', color: active ? COLORS.white : color }}>{label}</Text>
                        </TouchableOpacity>
                      );
                    })}
                  </View>
                  <Text style={[lblS, { color: '#23874A', marginTop: 10 }]}>Visit Date *</Text>
                  <TouchableOpacity onPress={() => setShowSvVisitedDate(true)} style={{ borderWidth: 1.5, borderColor: COLORS.link, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.white }}>
                    <Ionicons name="calendar-outline" size={16} color={BLUE} />
                  ...
                  {!svOutcome && <Text style={{ fontSize: 11, color: '#23874A', marginTop: 6 }}>Pick how the visit went — recorded on the site visit.</Text>}
              ...
              {form.stm_status === 'closed' && (
                <View style={{ backgroundColor: '#F4F5F7', borderWidth: 1, borderColor: '#C9F8CA', borderRadius: 16, padding: 12, marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                  <Ionicons name="checkmark-circle-outline" size={16} color="#23874A" />
                  <Text style={{ fontSize: 12, color: '#23874A', fontWeight: '600', flex: 1 }}>
                ...
                <View key={fu.id} style={{ borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 16, padding: 14, marginBottom: 12 }}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                    <View style={{ flexDirection: 'row', gap: 8 }}>
                      ...
                      <View style={{ paddingHorizontal: 8, paddingVertical: 2, borderRadius: 14, backgroundColor: (FU_STATUS_COLOR[fu.status] || MUTED) + '18' }}>
  ...
  return (
      <View style={{ backgroundColor: COLORS.screenBg, borderRadius: 16, padding: 14, borderWidth: 1.5, borderColor: COLORS.border, marginBottom: 20 }}>
        ...
        <TextInput value={fuForm.remarks} onChangeText={v => setFuForm(f => ({ ...f, remarks: v }))}
          placeholder="Call notes, instructions…" placeholderTextColor="#55585E" multiline style={[inpS, { minHeight: 70, textAlignVertical: 'top' }]} />
          ...
          <ScrollView style={{ flexShrink: 1 }} contentContainerStyle={{ padding: 20 }}>
            ...
            <Field label="Lead Received Date">
              <TouchableOpacity onPress={() => setShowLeadDatePicker(true)}
                style={{ borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.white }}>
            ...
            {showStm && (
              <>
                ...
                {form.stm_status === 'sv_done' && (
                  <View style={{ backgroundColor: '#F4F5F7', borderWidth: 1, borderColor: '#C9F8CA', borderRadius: 16, padding: 12, marginBottom: 16 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                      <Ionicons name="location-outline" size={14} color="#23874A" />
                      <Text style={{ fontSize: 11, fontWeight: '800', color: '#23874A', letterSpacing: 0.5 }}>VISIT OUTCOME</Text>
                    </View>
                    ...
                    <Text style={{ fontSize: 12, fontWeight: '600', color: '#23874A', marginTop: 10, marginBottom: 6 }}>Visit Date *</Text>
                    <TouchableOpacity onPress={() => setShowSvVisitedDate(true)} style={{ borderWidth: 1.5, borderColor: COLORS.link, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.white }}>
    ...
    <FormSheet visible={visible} onClose={onClose}>
        ...
        <ScrollView style={{ flexShrink: 1 }} contentContainerStyle={{ padding: 16, gap: 16 }}>
          ...
          <View>
            ...
            <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}>
              <TouchableOpacity onPress={() => setShowFromPicker(true)}
                style={{ flex: 1, borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.white }}>
                <Ionicons name="calendar-outline" size={16} color={MUTED} />
          ...
          <TouchableOpacity onPress={() => set('is_duplicate', !local.is_duplicate)}
            style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 14, borderRadius: 16, borderWidth: 1.5, borderColor: local.is_duplicate ? COLORS.errorStrong : COLORS.border, backgroundColor: local.is_duplicate ? COLORS.screenBg : COLORS.white }}>
          ...
          <TouchableOpacity onPress={() => set('unassigned', !local.unassigned)}
            style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 14, borderRadius: 16, marginTop: 10, borderWidth: 1.5, borderColor: local.unassigned ? COLORS.gold : COLORS.border, backgroundColor: local.unassigned ? COLORS.screenBg : COLORS.white }}>
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: BG }} edges={['top']}>
      ...
      <Modal visible={!!xferLead} transparent animationType="fade" onRequestClose={() => setXferLead(null)}>
        <TouchableOpacity activeOpacity={1} onPress={() => setXferLead(null)}
          style={{ flex: 1, backgroundColor: 'rgba(29,29,31,0.45)', justifyContent: 'center', padding: 20 }}>
          <TouchableOpacity activeOpacity={1} onPress={() => {}}
            style={{ backgroundColor: COLORS.white, borderRadius: 20, overflow: 'hidden' }}>
