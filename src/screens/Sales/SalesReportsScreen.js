...
export default function SalesReportsScreen({ navigation }) {
  ...
  const TELECALLER_CARDS = [
    ...
    { label: 'To Call',      value: _toCall,                      color: COLORS.warning, bg: COLORS.warningBg, target: 'SalesLeads', params: { initialFilter: { ...dateFilter } } },
  ...
  const STM_CARDS = [
    ...
    { label: 'To Work',      value: _toCall,                              color: COLORS.warning, bg: COLORS.warningBg, target: 'SalesLeads', params: { initialFilter: { ...dateFilter } } },
