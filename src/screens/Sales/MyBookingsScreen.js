  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.screenBg }} edges={['top']}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 16, paddingVertical: 12, backgroundColor: COLORS.white, borderBottomWidth: 1, borderBottomColor: COLORS.surfaceAlt }}>
        ...
        <View>
          <Text style={{ fontSize: 18, fontWeight: '800', color: TEXT }}>My Bookings</Text>
          <Text style={{ fontSize: 12, color: MUTED }}>{rows.length} unit{rows.length === 1 ? '' : 's'} you booked · revise the LOI anytime</Text>
        </View>
      </View>
