...
const MODULE_CONFIG = {
  ...
  Execution:            { title: 'Execution',           desc: 'Tasks, milestones and project delivery',      icon: 'construct',       tone: 'green', screen: 'ModuleHome',  getParams: () => ({ module: 'Execution', name: 'Execution' }) },
