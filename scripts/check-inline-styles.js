 ...
 *   App → src/styles/common.js (shared StyleSheet), src/components/ui (Button,
 *   Card, Badge, MetricTile, ListRow, Segmented, StatCard) and COLORS / RADIUS /
 *   SHADOWS tokens from src/constants/theme.js. Screen-specific styles go in a
 *   StyleSheet.create() at the bottom of the screen file.
 *
